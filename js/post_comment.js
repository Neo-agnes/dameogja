...
var POST_COMMENT = function(){
	...
	var commentDecreaseTotalCount = function(decrease_count){
		decrease_count = (decrease_count != 'undefined' && decrease_count != '') ? decrease_count : 1;
		comment_count_obj.text(total_count - decrease_count);
	};
